    ...
    <div>
      <GridContainer className="grid-container">
        <Grid className="grid">
          ...
          <GridLayer className="gridLayer">
            <GridBlock10 className="gridBlock" />
          </GridLayer>
          <GridLayer className="gridLayer">
            <GridBlock11 className="gridBlock" />
          </GridLayer>
          <GridLayer className="gridLayer">
            <GridBlock12 className="gridBlock" />
          </GridLayer>
          <GridLayer className="gridLayer">
            <GridBlock13 className="gridBlock" />
          </GridLayer>
          <GridLayer className="gridLayer">
            <GridBlock14 className="gridBlock" />
          </GridLayer>
          <GridLayer className="gridLayer">
            <GridBlock15 className="gridBlock" />
          </GridLayer>
        </Grid>
      </GridContainer>
    </div>
