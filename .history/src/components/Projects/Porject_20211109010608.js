                    ...
                    {data.map((index,) =>
                        <ProjectsContainer key={index.id}>
                            <SingleProjectContainer1>
                                <SingleProjectImage>
                                    <SingleProjectImg onMouseOver={() => setImage(index.hoverImg1)}
                                                      src={index.img1} className="cursor-hover"/>
                                    <div className="custom-cursor">
                                        <CustomCursorBig id="cursor-big"
                                                         className="custom-cursor__ball custom-cursor__ball--big"
                                                         hoverImage={image}/>
                                        <CustomCursorSmall id="cursor-small"
