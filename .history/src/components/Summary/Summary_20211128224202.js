    ...
    <div class="app ">
      <div class="brand__header">
        <div class="align__right">
          ...
          <span class="rotated">Motivation</span>
        </div>
        <div class="asterisk">
          <svg
        ...
        <main class="content">
          <div class="section reverse">
            ...
            <div class="section__body">
              ...
              <div class="section__body__text">
                <p>
                  I mostly spend my time with coding. Eating and Sleeping, tbh
                </p>
              </div>
            </div>
          </div>
          <div class="section">
            ...
            <div class="section__body">
              ...
              <div class="section__body__text">
                <p>
                  I mostly code from yt tutorials and i try do it myself, if it
                  works i move on. I really like using StackOverflow for solving
                  problems
                </p>
              </div>
            </div>
          ...
          <div class="section reverse">
            ...
            <div class="section__body">
              <div class="section__body__header">
                <h2>How i treat other people</h2>
                <span class="reverse">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="72"
              ...
              <div class="section__body__text">
                <p>
  I like to treat to people in a way that not try to offend them. But i am sometimes introvert when i am upset or wanna 
                </p>
              </div>
            </div>
          </div>
        ...
        <footer>
          <a href="#">Time to hire me. Isn't it?</a>
